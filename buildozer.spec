...
# (str) Package name
package.name = hosseinapp

# (str) Package domain (needed for android/ios packaging)
package.domain = org.hossein
...
#       [app]
#       title = Hossein App # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = Hossein App
#          package.name = hosseinapp # This is all part of the title.
#
